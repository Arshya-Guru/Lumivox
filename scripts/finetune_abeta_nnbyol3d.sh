#!/bin/bash
# Abeta segmentation FT from nnBYOL3D pretrained encoder.
...
pixi run python -m lumivox.training.finetune_lightning \
    ...
    --devices 2 \
    --save-dir ./checkpoints/finetune_abeta_nnbyol3d_frozen \
    --seed 42
